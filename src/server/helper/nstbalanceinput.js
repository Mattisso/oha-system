  ...
  popular: function (callback) {
      async.waterfall([
          ...
          function (nstbalanceinputs, callback) {
              ...
              async.eachSeries(nstbalanceinputs, function (nstbalanceinput, secondcallback) {
                  var ocompteids = nstbalanceinput.ocompte_id  //_.map(nstbalanceinput.oreference, '_id');
                  Models.oStblArea.find({ 'ocomptes._id': ocompteids }, '_id',
                      ...
                      function (err, oexercices) {
                          if (err) {
                              ...
                              async.eachSeries(oexercices, function (oexercice, ocomptecallback) {
                                  ...
                                  obj = {
                                      oexerccompta_id: oexercice._oexerccompta_id,
